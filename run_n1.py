...
parser.add_argument('-mp','--model_path',default=None, help='load a model from the path')
parser.add_argument('--save_model_dir',default=None, help='save a model to the folder')
...
parser.add_argument('--predict_file',default=None, help='output')
parser.add_argument('--epoch',default=100, type=int, help='epoch number')
parser.add_argument('--save_step',default=1000, type=int, help='how many steps to save a model')
parser.add_argument('--use_random_embed',default=0, type=int, help='whether or not to use random embeddings')
parser.add_argument('--word_embed_h5',default=None,  help='path fo word embeddings')
parser.add_argument('--word_embed_voc',default=None, help='path of vocab')
parser.add_argument('--char_voc',default=None, help='path of vocab')
parser.add_argument('--build_voc',default=None, help='path of build vocab')
